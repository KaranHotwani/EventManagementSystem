<html>
	...
	<body style="border:1px solid black">
		...
		<h2 class="header"> PYTHON SEMINAR</h2>
	
		<p> <b>DETAILS:</b> <br>This seminar is arranged by ves institute of technology.<br> It is the course of 7 days and 2 hours 
			each day after college.Two batches are available<br> 1. 3-5pm <br>2. 4-6pm.<br> Certificates will be given for 
			participation and for performing practical exams.<br><br>Enter your details below for participation. </p>
...
<?php
	...
	if(isset($_POST['participate']))
	{
		...
		$sql="insert into python values ('$name1','$name2','$CRNO')";
...
$sql = "SELECT Name,class_rollno FROM python ";
