<html>
	...
	<body style="border:1px solid black">
		...
		<h2 class="header">	TRESURE HUNT</h2>
	
		<p> <b>DETAILS:</b> <br>This event is arranged by SPIT Institute Of Technology.<br><br> It will take place in group of 5 persons.
		Top three winners will be awarded by goodies and certificates. This event is held at amphi theatre on next saturday.Do participate
		in large numbers
...
<?php
	...
	if(isset($_POST['participate']))
	{
		...
		$sql="insert into t_hunt values ('$name1','$name2','$CRNO')";
...
$sql = "SELECT Name,class_rollno FROM t_hunt ";
